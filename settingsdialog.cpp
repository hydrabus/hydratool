    ...
    ui(new Ui::SettingsDialog)
{
    ...
    intValidator = new QIntValidator(0, 8000000, this);
...
void SettingsDialog::fillPortsParameters()
{
    ...
    ui->baudRateBox->addItem(QStringLiteral("FTDI 8.4M"), 6300000);
...
void SettingsDialog::fillPortsInfo()
{
    ...
    foreach (const QSerialPortInfo &info, QSerialPortInfo::availablePorts()) {
        ...
        if(description.contains("Intel(R) Active Management Technology - SOL"))
            continue;
...
void SettingsDialog::updateSettings()
{
    ...
    if (ui->baudRateBox->currentIndex() == 5) {
        ...
        currentSettings.baudRate = ui->baudRateBox->currentData().toInt();
         /*
...
/*
 * TODO: save last serial port settings
    settings.beginGroup("hydratoolserial");
...
{
    Q_UNUSED(event);
    bool apply_settings_val;

    apply_settings_val = apply_settings;
    apply_settings = false;

    emit settings_hide(apply_settings_val);
}
